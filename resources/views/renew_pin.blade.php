		...
		<ol class="breadcrumb">
			...
			<li>
				<form action="{{ url('export-renewhub-status') }}" method="post">
					...
					<input type="hidden" name="barcode[]" value="{{ $item->barcodes }}">
			...
			<li>
				<a href="javascript:;"><button class="btn btn-info" onclick="importPrice()">Import Price</button></a>
				&nbsp;&nbsp;
			</li>
		</ol>
	</div>
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-md-12" style="padding: 17px;">
						...
						<a href="{{url('assets\files\renew_import.csv')}}" class="btn btn-info light" download>Download
							Sample File</span></a>
					</div>
				</div>
			</div>
...
<div id="importPrice" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ url('renew-hub-status-update-price') }}" method="post" enctype="multipart/form-data">
					@csrf
					<input type="file" name="file" class="form-control">
					<button type="submit" class="btn btn-success mr-1">Submit
						<span class="btn-icon-right">
...
<div id="remarkModel" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				{!! Form::open(['url' =>'remark-stock-in-barcode', 'class' => 'form-horizontal', 'id' => 'remark-form',
