				...
				<div class="panel panel-default">
					<div class="panel-heading d-flex">
						...
						<div class="d-flex">
							...
							{!! Form::open(['url' =>'export-els-product-report-in', 'class' => 'form-horizontal', 'role'
							=> 'form']) !!}
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					{!! Form::open(['url' =>'upload-change-status', 'class' => 'form-horizontal', 'id' => 'save-form',
...
// 			{ data: "out_vendor" },
		...
		"rowCallback": function (nRow, aData, iDisplayIndex) {
			...
			// if($indicators == 0)
			// {
				indicatorBtn += '<label class="switch"><input value="0" type="checkbox" class="statuscheckbox"><span class="slider round"></span></label>';
			// }
			// else
			// {
				indicatorBtn += '<label class="switch"><input value="1" type="checkbox" class="statuscheckbox"><span class="slider round"></span></label>';
			// }
