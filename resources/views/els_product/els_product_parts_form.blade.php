...
<table id="childTable" class="table-responsive table-bordered table">
    <thead>
        <tr>
            ...
            <td>Part Color</td>
            <td>PIN</td>
            <td><a href="javascript:;" id="add_more_parts" onclick="addMore({{ count($parts) }})"><span class="glyphicon glyphicon-plus"></span></a></td>
            <td>Old PINs</td>
        </tr>
    </thead>
    <tbody>
            ...
            @foreach ($parts as $key => $d)
                ...
                <tr id="row_{{ $key }}" <?php if($barcode!='' ){ ?> <?php } ?>>
                    ...
                    <td style="display: flex;align-items: center;gap: 1rem;">
                        ...
                        @if ($barcode)
                            <a href="{{ url('/generate_bar_code?pin=' . $barcode . '&imei=' . $data->sku_no . '') }}" target="_blank" rel="noopener noreferrer"><span class="glyphicon glyphicon-print"></span></a>
                        @endif
                    </td>
                    <?php  }  else {   ?>
                    ...
                    @if ($d->barcodes)
                        <a href="{{ url('/generate_bar_code?pin=' . $d->barcodes . '&imei=' . $data->sku_no . '') }}" target="_blank" rel="noopener noreferrer"><span class="glyphicon glyphicon-print"></span></a>
                    @endif
                    </td>
                    ...
                    <td class="action">
						...
						value="Renew">Renew</button></form>
				<a onclick="cloneRow(event)" id="clone" class="btn btn-primary">Renew</a> --}}
                        <a onclick="cloneRowNew({{ $key }})" class="btn btn-primary">Renew</a>
                        <?php  }  ?>
                    ...
                    {!! Form::hidden('order_request_part_imei[]', $data->sku_no, ['id' => 'order_request_part_imei_' . $key, 'class' => 'order_request_part_imei']) !!}
