...
// console.log(id);
			...
			var actionBtn = '<a href="javascript:;" onclick="changeStatus('+aData.allocated_id+','+aData.status_id+')"><i class="fa fa-edit text-primary mr-2"></i></a> &nbsp;&nbsp;<form action="{{ url('update-pin') }}/'+id+'"><button class="btn btn-primary" value="Renew">Renew</button></form>';
			<?php }   else {  ?>
				var actionBtn ='';
			<?php  }  ?>
