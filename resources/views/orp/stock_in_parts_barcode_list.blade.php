				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-6">
								{!! Form::text('barcode', '', ['class' => 'form-control required', 'id'=>'barcode',
								'placeholder'=>'Barcode','onkeypress'=>'enterKeyPress(event)']) !!}
				...
				<div class="panel panel-default">
					<div class="panel-heading d-flex">
						...
						<div class="d-flex">
							...
							<?php  } ?>
							{!! Form::open(['url' =>'export-spart-part-barcode-report', 'class' => 'form-horizontal',
							'role' => 'form']) !!}
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				{!! Form::open(['url' =>'upload-stock-in-report', 'class' => 'form-horizontal', 'id' => 'upload-form',
