                                ...
                                <tr>
                                    ...
                                    <td class="col-md-2">
                                        <select name="item[1][part_id]" id="item_1" class="form-control">
                                            @foreach($items as $item)
                                            <option class="dispalyN" value="{{$item->id}}">{{$item->name}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td class="col-md-2">
                                        <select name="item[1][model_id]" id="model_1" class="form-control">
                                            @foreach($models as $model)
                                            <option class="dispalyN" value="{{$model->id}}">{{$model->mname}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td class="col-md-2">
                                        <select name="item[1][color_id]" id="color_1" onchange="return generateSku(1)"
                                            class="form-control">
                                            @foreach($colours as $colour)
                                            <option class="dispalyN" value="{{$colour->id}}">{{$colour->name}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td class="col-md-1">
                                    ...
                                    <td class="col-md-1">
                                        <input type="text" name="item[1][quantity]" id="quantity_1" class="
                                            form-control" />
                                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;"><button class="btn btn-info"
                                            onclick="	$('#importModel').modal('show');">view</button></a> &nbsp;&nbsp;
                                    @include('my_modal')
 ...
 let data=document.querySelector('.showeddata').style.index="2";
    ...
    function get_data()
    {
        ...
        }).done(function (response)
        {
            ...
            if(is_not_null_array(part) && is_not_null_array(model) && is_not_null_array(color) && is_not_null_array(quantity)) {
                ...
                for (let index = 1; index < part.length; index++) {
                    count++;
                    childrenRoww(count, part[index]['id'], part[index]['name'], model[index]['id'], model[index]['mname'], color[index]['id'], color[index]['name'], quantity[index]);
                    generateSku(count);
                }
            }
